    ...
    <footer className="bg-[#1A1A1A] pt-24 pb-0 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 mb-24 opacity-70 hover:opacity-100 transition-opacity duration-500">
          <img src="/assets/logos/google-partner.png" alt="Google Partner" className="h-10 md:h-12 w-auto object-contain brightness-0 invert hover:brightness-100 hover:invert-0 transition-all" />
          <img src="/assets/logos/meta-partner.png" alt="Meta Business Partner" className="h-10 md:h-12 w-auto object-contain brightness-0 invert hover:brightness-100 hover:invert-0 transition-all" />
          <img src="/assets/logos/tiktok-partner.png" alt="TikTok Marketing Partner" className="h-10 md:h-12 w-auto object-contain brightness-0 invert hover:brightness-100 hover:invert-0 transition-all" />
          <img src="/assets/logos/shopee.svg" alt="Shopee" className="h-8 md:h-10 w-auto object-contain brightness-0 invert hover:brightness-100 hover:invert-0 transition-all" />
          <img src="/assets/logos/google-ads.png" alt="Google Ads" className="h-10 md:h-12 w-auto object-contain brightness-0 invert hover:brightness-100 hover:invert-0 transition-all" />
        </div>
